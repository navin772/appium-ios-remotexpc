...
export class ServiceConnection {
     ...
     */
    static parsePlistResponse(payload: Buffer, headerSize: number = 4): Record<string, any>[] | null {
        ...
        try {
            ...
            while (true) {
                ...
                const xmlDeclStart = Math.max(0, xmlStr.lastIndexOf('<?xml', plistStart));
     ...
     */
    sendPlistRequest(requestObj: Record<string, any>): Promise<Record<string, any>[] | null> {
