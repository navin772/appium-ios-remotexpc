...
export function sendUsbmuxPlistRequest(
    ...
    return new Promise((resolve, reject) => {
        ...
        const timeoutId = setTimeout(() => {
            ...
            reject(new Error(`Timeout waiting for response with tag ${requestObj.tag || 0} after ${timeout}ms`));
        }, timeout);
        ...
        const onData = (data: Buffer) => {
            ...
            try {
                ...
                console.warn('Error processing usbmux data (will continue waiting for more data):', err);
